    ...
    <AppLayout title="Books">
      ...
      {canManage && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={openCreate}
          className="fixed bottom-8 right-8 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-r from-teal-500 to-teal-600 text-2xl text-white shadow-xl shadow-teal-600/30 transition-all md:bottom-10 md:right-10"
          title="Add New Book"
        >
